...
import packagedfoodposter from '../../image/Home/packaged-poster.jpg';
...
function Packagedfood() {
    ...
    useEffect(() => {
        ...
        setPackagedfood(storedData[13]?.packagedfood || [])
    ...
    const AddCart = (id) => {
        ...
        setCartitem(prevState => ({
            ...prevState,
            [id]: packagedfood.find(item => item.id === id)
        }));
    ...
    return (
        <div>
            ...
            <img src={packagedfoodposter} alt='packagedfood-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {packagedfood.map((data, index) => (
