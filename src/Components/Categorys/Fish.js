...
import fishposter from '../../image/Home/fish-poster.jpg';
...
function Fish() {
    ...
    return (
        <div>
            ...
            <img src={fishposter} alt='fish-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {fish.map((data, index) => (
