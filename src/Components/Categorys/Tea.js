...
import teaposter from '../../image/Home/tea-poster.jpg';
...
function Tea() {
    ...
    return (
        <div>
            ...
            <img src={teaposter} alt='tea-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {tea.map((data, index) => (
