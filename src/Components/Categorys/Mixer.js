...
import mixerposter from '../../image/Home/mixer-poster.webp';
...
function Mixer() {
    ...
    return (
        <div>
            ...
            <img src={mixerposter} alt='mixer-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {mixer.map((data, index) => (
