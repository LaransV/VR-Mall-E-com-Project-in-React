...
import cookwareposter from '../../image/Home/cookware-poster.jpg';
...
function Cookware() {
    ...
    useEffect(() => {
        ...
        setCookware(storedData[5]?.cookware || [])
    ...
    const AddCart = (id) => {
        ...
        setCartitem(prevState => ({
            ...prevState,
            [id]: cookware.find(item => item.id === id)
        }));
    ...
    return (
        <div>
            ...
            <img src={cookwareposter} alt='cookware-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {cookware.map((data, index) => (
