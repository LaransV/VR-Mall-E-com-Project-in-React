...
import drinksposter from '../../image/Home/drinks-poster.avif';
...
function Drinks() {
    ...
    const AddCart = (id) => {
        ...
        setCartitem(prevState => ({
            ...prevState,
            [id]: drinks.find(item => item.id === id)
        }));
    ...
    return (
        <div>
            ...
            <img src={drinksposter} alt='drinks-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
