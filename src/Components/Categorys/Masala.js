...
import masalaposter from '../../image/Home/masala-poster.jpg';
...
function Masala() {
    ...
    useEffect(() => {
        ...
        setMasala(storedData[12]?.masala || [])
    ...
    const AddCart = (id) => {
        ...
        setCartitem(prevState => ({
            ...prevState,
            [id]: masala.find(item => item.id === id)
        }));
    ...
    return (
        <div>
            ...
            <img src={masalaposter} alt='masala-poster' style={{ width: "100%" }} ></img>
            <div id='list'>
                {masala.map((data, index) => (
